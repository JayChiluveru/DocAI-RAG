"""
This file contains DocAI-RAG program implemented using Python.
DocAI-RAG is a simple Retrieval-Augmented Generation (RAG) system that allows users to ask questions about the contents of various file formats.
